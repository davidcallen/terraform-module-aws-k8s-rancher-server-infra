...
# Note that we allow PassRole for rolenames "*-k8s-rancher-managed-nodes" so the rancher-provisioned managed
# clusters are allow to set an instance profile on themselves.
    ...
    "Statement": [
        ...
        },
        {
            ...
            "Resource": [
                ...
                "arn:aws:iam::${var.environment.account_id}:role/${var.environment.resource_name_prefix}-*-k8s-rancher-managed-nodes"
            ]
        },
        {
